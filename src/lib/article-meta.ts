// Metadatos ligeros de articulos para el blog listing (sin contenido de bloques).
...
export const articleMeta: ArticleMeta[] = [
  ...
  },
  {
    ...
    "titleES": "Malestar sin nombre: cuando algo no encaja pero no sabes decir qué",
    ...
    "excerptES": "Hay un tipo de malestar que no encaja en ninguna categoría clara. No es tristeza ni ansiedad: es una sensación difusa de que algo no funciona. Por qué aparece en la madurez adulta y cuándo tiene sentido buscar un psicólogo en Barcelona aunque no tengas una queja definida.",
  ...
  },
  {
    ...
    "excerptCA": "La freqüència de les sessions de psicologia no és fixa: depèn del moment del procés, de la intensitat del malestar i dels objectius. La pauta més habitual al començament és setmanal, per passar a quinzenal i, en fase de consolidació, mensual. Aquí expliquem per què i quan convé canviar el ritme.",
    "excerptES": "La frecuencia de las sesiones de psicología no es fija: depende del momento del proceso, de la intensidad del malestar y de los objetivos. La pauta más habitual al comienzo es semanal, para pasar a quincenal y, en fase de consolidación, mensual. Aquí explicamos por qué y cuándo conviene cambiar el ritmo.",
  ...
  },
  {
    ...
    "excerptCA": "La sanitat pública a Barcelona ofereix atenció psicològica gratuïta, però amb llistes d'espera i un enfocament limitat a la urgència. La privada aporta rapidesa, continuïtat i especialització, a canvi d'un cost. Aquí expliquem com funciona cadascuna, què cobreixen i com decidir.",
    "excerptES": "La sanidad pública en Barcelona ofrece atención psicológica gratuita, pero con listas de espera y un enfoque limitado a la urgencia. La privada aporta rapidez, continuidad y especialización, a cambio de un coste. Aquí explicamos cómo funciona cada una, qué cubren y cómo decidir.",
  ...
  },
  {
    ...
    "excerptCA": "L'ansietat d'alt funcionament afecta persones que ho fan tot bé. Descobreix les senyals invisibles i com tractar-la. Teràpia a Barcelona.",
    "excerptES": "La ansiedad de alto funcionamiento afecta a personas que lo hacen todo bien. Descubre las señales invisibles y cómo tratarla. Terapia en Barcelona.",
    "datePublished": "2026-05-01"
  },
  {
    ...
    "excerptCA": "Si vius a Barcelona i l'ansietat està afectant la teva vida diària, no estàs sol/a. Hi ha formes efectives de recuperar la calma i el control.",
    "excerptES": "Si vives en Barcelona y la ansiedad está afectando tu vida diaria, no estás solo. Existen formas efectivas de recuperarla calma y el control.",
    "datePublished": "2026-05-01"
  },
  {
    ...
    "excerptCA": "La coherència interna és l'alineació entre el que sents, penses i fas. Quan no existeix, apareix el malestar. Aprèn a reconèixer-la.",
    "excerptES": "La coherencia interna es la alineación entre lo que sientes, piensas y haces. Cuando no existe, aparece el malestar. Aprende a reconocerla.",
    "datePublished": "2026-05-01"
  },
  {
    ...
    "excerptCA": "La rumiació ansiosa és un bucle de pensaments que no para. Aprèn a reconèixer-la i a trencar el cicle. Teràpia humanista a Barcelona.",
    "excerptES": "La rumiación ansiosa es un bucle de pensamientos que no para. Aprende a reconocerla y a romper el ciclo. Terapia humanista en Barcelona.",
    "datePublished": "2026-05-01"
  },
  {
    ...
    "excerptCA": "El silenci a la parella pot ser pau o pot ser distància. Aprèn a distingir i a reconstruir la comunicació. Teràpia de parella a Barcelona.",
    "excerptES": "El silencio en la pareja puede ser paz o puede ser distancia. Aprende a distinguir y a reconstruir la comunicación. Terapia de pareja en Barcelona.",
    "datePublished": "2026-05-01"
  },
  {
  ...
  },
  {
    ...
    "excerptCA": "Descobreix l'enfocament de Carl Rogers i per què la teràpia centrada en el client pot ser transformadora. Psicologia humanista a Barcelona.",
    "excerptES": "Descubre el enfoque de Carl Rogers y por qué la terapia centrada en el cliente puede ser transformadora. Psicología humanista Barcelona.",
